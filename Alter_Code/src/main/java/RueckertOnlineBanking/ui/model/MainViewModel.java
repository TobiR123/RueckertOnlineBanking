...
//        this.eMailAddress = new EMailAddress();
    ...
    private EMailAddress createdEmailAddress;
    ...
    public String registerCustomer() throws ParseException {
        ...
        this.pin = this.createdCustomer.getPinNumber().getPinNumber();
//        this.createdAddress = newAddress;
//        this.createdEmailAddress = newEmailAddress;

        return "customers/afterRegistrationViewWithTemplate.xhtml";
    }
    ...
    public String updateCustomer() throws ParseException {
        ...
        Customer updatedCustomer = service.updateCustomer(this.createdCustomer.getId(), this.firstname, this.lastname, this.createdCustomer.getEmailAddress().getId(), this.eMailAddress, this.phoneNumber, new SimpleDateFormat("yyyy-MM-dd").parse(this.dateOfBirth), this.createdCustomer.getAddress().getId(), this.createdCustomer.getAddress().getStreet(), this.createdCustomer.getAddress().getHouseNumber(), this.createdCustomer.getAddress().getPostcode(), this.createdCustomer.getAddress().getPlace(), this.createdCustomer.getPinNumber().getId(), this.pin);
        System.out.println(updatedCustomer);
        this.createdCustomer = updatedCustomer;
